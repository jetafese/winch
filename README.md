...
`/path-to-seahorn/build/run/bin/sea yama -y verify/sea.yaml bpf target/release/deps/winch_codegen-2.ll`

There is an automated way to achieve this: run `just build && just verify /path-to-seahorn/build/run/bin/sea`
