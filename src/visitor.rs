...
use crate::regalloc2::RegClass;
use smallvec::{smallvec, SmallVec};
use crate::wasmparser::{
    BlockType, BrTable, Ieee32, Ieee64, MemArg, VisitOperator, V128,
};
use crate::wasmtime_cranelift::TRAP_INDIRECT_CALL_TO_NULL;
    ...
    M: MacroAssembler,
{
    ...
    // crate::wasmparser::for_each_visit_operator!(def_unsupported);
}
...
//     // crate::wasmparser::for_each_visit_simd_operator!(def_unsupported);
// }
