...
// };
// use std::mem;
// use crate::wasmparser::BlockType;
use crate::wasmtime_environ::{
    // BuiltinFunctionIndex, 
    FuncIndex, 
    // GlobalIndex, IndexType, Memory, MemoryIndex,
    // ModuleTranslation, ModuleTypesBuilder, PrimaryMap, 
    PtrSize,  
...
//             namespace: crate::wasmtime_cranelift::NS_WASMTIME_BUILTIN,
//             index: builtin.index(),
//         })
//     }
...
//         self.intern_name(UserExternalName {
//             namespace: crate::wasmtime_cranelift::NS_WASM_FUNC,
//             index: index.as_u32(),
//         })
//     }
...
//     fn lookup_heap_type(&self, idx: crate::wasmparser::UnpackedIndex) -> WasmHeapType {
//         crate::wasmtime_environ::WasmparserTypeConverter::new(self.types, |idx| {
...
//         &self,
//         index: crate::wasmparser::UnpackedIndex,
//     ) -> crate::wasmtime_environ::EngineOrModuleTypeIndex {
//         crate::wasmtime_environ::WasmparserTypeConverter::new(self.types, |idx| {
//             self.translation.module.types[idx]
//         })
