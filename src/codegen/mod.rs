...
//     VisitSimdOperator,
// };
use crate::wasmtime_cranelift::{TRAP_BAD_SIGNATURE, TRAP_TABLE_OUT_OF_BOUNDS};
    ...
    M: MacroAssembler,
{
    ...
    fn emit_body(
        ...
        where
            T: VisitSimdOperator<'a, Output = crate::wasmparser::Result<()>>,
            U: VisitSimdOperator<'a, Output = Result<()>> + VisitorHooks,
        {
            ...
            // crate::wasmparser::for_each_visit_operator!(validate_then_visit);
        }
        ...
        //     U: VisitSimdOperator<'a, Output = Result<()>> + VisitorHooks,
        // {
        //     crate::wasmparser::for_each_visit_simd_operator!(validate_then_visit);
        // }
    }
