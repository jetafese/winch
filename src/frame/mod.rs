...
impl Frame<Prologue> {
    ...
    //     Ok(Self { locals_size: 32, marker: PhantomData, wasm_locals: Default::default(), defined_locals_range: DefinedLocalsRange(0..4), results_base_slot: None, special_locals: [LocalSlot::i32(0), LocalSlot::i32(4)] })
    // }
