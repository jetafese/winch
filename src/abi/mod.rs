...
//! |                               |
use crate::isa::x64::masm::ptr_type_from_ptr_size;
...
use crate::wasmtime_environ::{WasmFuncType, WasmValType};
...
macro_rules! scratch {
    ($m:ident) => {
        <$m::ABI as $crate::abi::ABI>::scratch_for(&crate::wasmtime_environ::WasmValType::I64)
    };
